...
#		Optional.  The following two options are available:
#
...
#			system.
#
#		Both configuration options are optional, but if present,
#		they must be begin in column 1 of the configuration file
#		and follow the exact format listed above.
#
